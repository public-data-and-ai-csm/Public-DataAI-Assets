...
Creating tickets is available to EVERYONE within the context of their own account.  In the context of another account (like most individual user situations), this ability is granted to particular users.  This is done through account management on the IBM Cloud ([read more about IAM here](#ibm-cloud-identity--access-management-iam)).  
...
- Looking for some videos? Why not try these video's by [James Belton](https://www.youtube.com/channel/UCwXEjUyETY0ft0RPlQYOKMA) on [Introduction to VMware on IBM Cloud](https://www.youtube.com/watch?v=yC9Ex6wcgUI&list=PLmesOgYt3nKCfsXqx-A5k1bP7t146U4rz&index=52&t=0s), [VMware Dedicated offerings](https://www.youtube.com/watch?v=hSsJUKyd1DM&list=PLmesOgYt3nKCfsXqx-A5k1bP7t146U4rz&index=53&t=0s), and [vCenter Onboarding](https://www.youtube.com/watch?v=BbtQ1UWhxT4&list=PLmesOgYt3nKCfsXqx-A5k1bP7t146U4rz&index=54&t=0s).  These cover these specific VMware topics in greater detail.
