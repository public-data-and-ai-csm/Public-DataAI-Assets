...
- [IBM Watson Assistant: How Do I Determine Unique Users?](https://medium.com/@modlanglais/ibm-watson-assistant-how-do-i-determine-unique-users-3aef8d3a2b8e) - a great article with some code examples which covers some ways to pass along user ID's to fit the MAU (Monthly Authorized Users) billing model now in place for Watson Assistant.
